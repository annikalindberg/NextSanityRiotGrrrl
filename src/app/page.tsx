...
import Me from "@/public/images/profil-square copy.jpg";
...
export default function Home() {
  ...
  <div className="divide-y divide-gray-100 dark:divide-gray-700">
      <div className="space-y-2 pt-5 pb-8 md:space-x-5">
        ...
        <span className="bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent"> Annika!</span>
      </h1>
      <p className="mt-3 text-xl">Aloha everyone! Check out my projects!</p>
