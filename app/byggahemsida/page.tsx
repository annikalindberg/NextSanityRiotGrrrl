        ...
        <div className="flex flex-col justify-center items-center  gap-3 lg:gap-5">
          ...
          <ul className=" text-xs space-y-2 flex justify-center flex-col">
            {[
              ...
              'Flexibla och konkurrenskraftig prismodell',
            ].map((item, index) => (
              <motion.li
                key={index}
          ...
          <h2 className="text-center text-[#36485C] text-lg lg:text-2xl mt-5  dark:text-white">
            {' '}
            Bygg för framtiden – skala upp när du behöver.
          </h2>
          <p className="pt-[16px] pb-[40px] text-center text-[#36485C] lg:text-[18px] mb-10 mt-7 leading-7  dark:text-white">
            Glöm begränsningarna med no-code plattformar; välj en lösning som
