        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              <p className="mt-4">
                ...
                exempelvis skärmläsare och för den som navigerar med
                tangentbord.
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              <p>
                ...
                processen att göra en webbplats tillgänglig och användbar för
                alla personer, oavsett funktionsnedsättning eller tekniska
                förutsättningar. Detta begrepp skiljer sig från enbart
                &quot;tillgänglighetsanpassning&quot;, som ofta kan uppfattas
                som att webbplatsen justeras för att passa specifika grupper. Vi
                ser det inte som en isolerad anpassning, utan snarare som en
              ...
              <p className="mt-4">
                ...
                planering till genomförande och vidare underhåll. Det handlar
                inte bara om att lägga till tillgängliga funktioner som en
                eftertanke, likt hur meta-taggar läggs till för SEO. Istället
                ser vi tillgängligheten som en grundläggande aspekt av
                webbdesign som påverkar allt från kodstruktur till
                användarinteraktion och visuell design.
              </p>
              <p className="mt-4">
                Att optimera för tillgänglighet handlar om att identifiera och
                ta bort hinder som kan begränsa användarnas förmåga att
                navigera, förstå och interagera med webbplatsen. Genom att se
                till att alla element på sidan är tillgängliga och fungerar
                smidigt för alla användare, inklusive de som använder assistiv
                teknik som skärmläsare, försäkrar vi att webbplatsen är
                inkluderande.
              </p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              ...
              <p className="mt-3">
                Har du inte själv rätt kunskap för att testa din webbplats, bör
                du anlita någon som har det. Ett första steg kan vara att boka
                kostnadsfri tillgänglighetsrådgivning med oss, för att få en
                första diagnos av din webbplats tillgänglighet och råd hur du
                ska ta nästa steg.
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-5">
            ...
            <AccordionContent>
              ...
              <p>
                ...
                dagligen. Om din webbplats har brister i tillgämglighet
                utesluter den cirk a 2 miljoner potentiella användare. detta är
                bara i Sverige.{' '}
              </p>
              <p className="mt-4">
                Det är inte bara personer med funktionsnedsättningar som
                påverkas av en otillgänglig webbplats. Äldre personer, personer
                med långsam internetuppkoppling, personer som använder
                mobiltelefoner och surfplattor, och personer som inte talar
                svenska som förstaspråk kan också ha svårt att använda en
                otillgänglig webbplats.
              </p>
              <p className="mt-4">
                Lägger vi dessutom till alla som har tillfälliga
                funktionshinder, vilket du själv säkert upplevt om du brutit ett
                finger eller bara glömt dina hörlurar och försöker kolla på en
                video på tåget, så blir det en stor del av befolkningen som
                påverkas negativt av en otillgänglig webbplats.{' '}
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-6">
            ...
            <AccordionContent>
              ...
              <p className="mt-3">
                Dessutom, många av de åtgärder som krävs för att göra en
                webbplats tillgänglighetsoptimerad, såsom att förbättra
          ...
          <AccordionItem value="item-7">
            <AccordionTrigger className="text-left">
              Om tillgänglighet är så viktigt, varför bygges inte alla
              webbplatser tillgänglighetsoptimerade från början?
            </AccordionTrigger>
            <AccordionContent>
              I Internets begynnelse skrevs alla hemsidor i ett kodspråk som
              kallas HTML. Denna teknik var och är fortfarande
              tillgänglighetsoptimerad i sig själv. Men när webben utvecklades
              och blev mer avancerad, tillkom fler tekniker och verktyg som
              gjorde det enklare att bygga webb och som inte alltid var lika
              ...
              <p className="mt-4">
                ...
                tillgänglighet, och med hjälp av plattformar som inte
                prioriterar tillgänglighet. Det är också så att det inte finns
                några lagkrav som tvingar webbplatser att vara
                tillgänglighetsoptimerade, vilket gör att många inte ser det som
                en prioritet.
              </p>{' '}
              <p className="mt-4">
                ...
                webbutveckling. Nu finns det också olika lagkrav som ställer
                krav på att vissa webbplatser ska vara
                tillgänglighetsoptimerade.
              </p>
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-8">
            <AccordionTrigger className="text-left">
              Innebär tillgänglighetsanpassning att min sida kommer att bli
              tråkig och ful?
            </AccordionTrigger>
            <AccordionContent>
              ...
              <p className="mt-4">
                ...
                ramarna för tillgänglighetsstandarder. Du kan fortfarande skapa
                en visuellt tilltalande webbplats som också är funktionell och
          ...
          <AccordionItem value="item-9">
            ...
            <AccordionContent>
              ...
              <p className="mt-3 mb-3">
                {' '}
                Det är viktigt att komma ihåg att tillgänglighet inte är något
                som kan läggas till i efterhand, utan något som måste byggas in
                i webbplatsen från början.{' '}
              </p>{' '}
              <p>
                En tillgänglighetsoptimerad webbplats är en webbplats som är
                utformad och utvecklad för att vara användbar för alla
                människor, inklusive personer med funktionsnedsättningar. Det
                innebär att webbplatsen är utformad för att vara lätt att
                navigera, förstå och använda för <strong>alla</strong> {''}
                användare, oavsett deras förmåga eller tekniska kunskaper.{' '}
              </p>
              <p className="mt-3 mb-3">
                Om du vill göra din webbplats mer tillgänglig är det bästa
                sättet att bygga in tillgänglighetsstandarder direkt i koden
                från början. Detta innebär att du behöver anlita en
                webbutvecklare som har kunskap om tillgänglighet och som kan
                implementera dessa standarder på rätt sätt.{' '}
              </p>
              <p>
                En &quot;quick fix&quot; är sällan en hållbar lösning när det
                kommer till tillgänglighet. Overlay-lösningar är inte bara
                ineffektiva ur tillgänglighetssynpunkt, de kan också vara
                olagliga enligt tillgänglighetsdirektivet och Europastandarden
                EN 301 549.{' '}
              </p>
              <p className="mt-3">
                {' '}
                Boka en kostnadsfri konsultation med oss för att diskutera hur
                vi kan hjälpa dig att göra din webbplats mer tillgänglig. Boka
                här:
              </p>
              <div className=" items-center flex justify-center mt-8 md:mt-10 lg:mt-20">
                ...
                >
                  Se vilka paket vi erbjuder och boka en kostnadsfri
                  konsultation
                </Link>
              </div>
            </AccordionContent>
