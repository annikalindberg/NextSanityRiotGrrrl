...
const projects: Project[] = [
  // Your projects data

    {
        ...
        stack: ["React JS", "Redux", "Node.js", "Express", "MongoDB", "API", "Axios", "React Testing Library", "Jest", "Google Cloud Platform", "Fullstack", ],
    ...
    },
    {
        ...
        stack: ["Express", "Mongo DB", "CSS", "JavaScript", "React", "API", "Axios", "Fullstack", "Node.js"],
    ...
    },
    {
        ...
        stack: ["HTML5", "CSS3", 'JavaScript', 'React', 'Redux', "Axios", "Node.js"],
    ...
    },
    {
        ...
        stack: ['Express', 'Mongo DB', 'JavaScript', "API", "Backend", 'API',"Node.js"],
